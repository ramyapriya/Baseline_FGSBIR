...
def overlay_points(images, points_output, tri_objects, color=(255,0,0)):
  new_images = []
  ct = 0
  for image, points_o in zip(images, points_output):
    ...
    tri = tri_objects[ct]
    plt.triplot(points_x, points_y, tri.simplices)
...
def save_detection_results(images, image_names, save_root=None, detections=None, categories=None, points_output=None, tri_objects=None,
  ...
  if save_points and save_objects:
    ...
    images1 = overlay_points(images1, points_output, tri_objects)
